 ...
 * Size: 30 px
 * Bpp: 4
 * Opts: --user-data-dir=C:\Users\16578\AppData\Roaming\gui-guider --app-path=D:\NXP\GUI-Guider-1.6.0-GA\resources\app.asar --no-sandbox --no-zygote --lang=zh-CN --device-scale-factor=1 --num-raster-threads=4 --enable-main-frame-before-activation --renderer-client-id=5 --time-ticks-at-unix-epoch=-1709115587153099 --launch-time-ticks=81835085193 --mojo-platform-channel-handle=3020 --field-trial-handle=1720,i,14593627426431400982,416760580278530288,131072 --disable-features=SpareRendererForSitePerProcess,WinRetrieveSuggestionsOnlyOnDemand /prefetch:1
 ******************************************************************************/
